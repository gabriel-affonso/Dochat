...
class S3VectorClient(VectorDBBase):
    """
    AWS S3 Vector integration for Dochat Knowledge.
    """
    ...
    def _filter_metadata(
        ...
        # Keep only the first 10 keys, prioritizing important ones based on actual Dochat metadata
        important_keys = [
    ...
    def get(self, collection_name: str) -> Optional[GetResult]:
        ...
        try:
            ...
            # The Dochat GetResult expects lists of lists, so we wrap each list
            if all_ids:
                return GetResult(
