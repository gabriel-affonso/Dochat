...
## Task
Based on the user's instruction, update and enhance the existing notes or selection by incorporating relevant and accurate information from the provided context. Always write the final result in Portuguese. Ensure all edits strictly follow the user’s intent.
...
- Deliver a single, rewritten version of the notes in Portuguese and in markdown format.
...
- Focus on improving clarity, completeness, and usefulness of the notes without drifting away from the requested edit.
- Return only the final, fully-edited markdown notes in Portuguese. Do not include explanations, reasoning, or XML tags.
`;
