...
async def get_headers_and_cookies(
    ...
    headers = {
        ...
        **(
            {
                "HTTP-Referer": "https://dochat.epilogos.eu/",
                "X-Title": "Dochat",
            }
...
def get_microsoft_entra_id_access_token():
    ...
    if DefaultAzureCredential is None or get_bearer_token_provider is None:
        log.error(
            "Azure authentication requested but azure-identity is not installed."
        )
        return None
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail=detail if detail else "Dochat: Server Connection Error",
            )
    ...
    if url_idx is None:
        ...
        async with aiohttp.ClientSession(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=500, detail="Dochat: Server Connection Error"
                )
            except Exception as e:
...
async def generate_chat_completion(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail="Dochat: Server Connection Error",
        )
    finally:
        if not streaming:
