...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "Dochat")
...
if FROM_INIT_PY:
    try:
        PACKAGE_DATA = {"version": importlib.metadata.version("dochat")}
...
DOCLING_SERVER_TIMEOUT = os.environ.get("DOCLING_SERVER_TIMEOUT", "300")

if DOCLING_SERVER_TIMEOUT == "":
    DOCLING_SERVER_TIMEOUT = 300
else:
    try:
        DOCLING_SERVER_TIMEOUT = int(DOCLING_SERVER_TIMEOUT)
    except Exception:
        DOCLING_SERVER_TIMEOUT = 300
