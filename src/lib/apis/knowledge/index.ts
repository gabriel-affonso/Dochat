...
export const getKnowledgeLinkedNotes = async (token: string, id: string) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/knowledge/${id}/notes`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const startKnowledgeSynthesisById = async (
	token: string,
	id: string,
	model?: string | null
) => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/knowledge/${id}/synthesis`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const regenerateKnowledgeSynthesisById = async (
	token: string,
	id: string,
	model?: string | null
) => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/knowledge/${id}/synthesis/regenerate`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getKnowledgeSynthesisStatusById = async (token: string, id: string) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/knowledge/${id}/synthesis/status`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getKnowledgeSynthesisById = async (token: string, id: string) => {
	let error = null;
...
export const addNoteToKnowledgeById = async (token: string, id: string, noteId: string) => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/knowledge/${id}/notes/add`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const removeNoteFromKnowledgeById = async (token: string, id: string, noteId: string) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/knowledge/${id}/notes/remove`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const upsertDirectorySyncFileToKnowledge = async (
	token: string,
	id: string,
	fileId: string,
	relativePath: string
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/knowledge/${id}/directory-sync/upsert`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
