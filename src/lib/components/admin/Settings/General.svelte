		...
		{#if adminConfig !== null}
			<div class="">
				<div class="mb-3.5">
						...
						<div class="flex w-full justify-between items-center">
							<div class="flex flex-col text-xs text-gray-700 dark:text-gray-200">
								<div class="flex gap-1">
									...
									{#if $config?.features?.enable_version_update_check}
										<a href={DOCHAT_SITE_URL} target="_blank">
											{updateAvailable === null
					...
					<div class="mb-2.5 rounded-2xl bg-gray-50 dark:bg-gray-850/60 p-4">
						<div class="flex w-full justify-between items-start gap-4">
							<div class="text-xs pr-2 space-y-3 text-gray-600 dark:text-gray-300">
								<div class="text-sm font-medium text-gray-900 dark:text-gray-100">
									{dochatAbout.title}
								</div>

								<p>{dochatAbout.summary}</p>

								<p>
									<span class="font-medium text-gray-800 dark:text-gray-100">
										{dochatAbout.pronunciation}
									</span>
									{` ${dochatAbout.meaning}`}
								</p>

								<p>{dochatAbout.vision}</p>
							</div>

							<a
								class="flex-shrink-0 text-xs font-medium underline text-gray-900 dark:text-gray-100"
								href={DOCHAT_SITE_URL}
								target="_blank"
							>
								dochat.epilogos.eu
							</a>
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								{#if $config?.license_metadata}
									<a href={DOCHAT_SITE_URL} target="_blank" class="text-gray-500 mt-0.5">
									...
									{/if}
								{:else}
									<a class=" text-xs hover:underline" href={DOCHAT_SITE_URL} target="_blank">
										<span class="text-gray-500">
											{$i18n.t(
												'Conheça a Epílogos e o Dochat para explorar modelos de licenciamento, identidade visual e suporte dedicado.'
											)}
										</span>
									</a>
								{/if}
						...
						{#if adminConfig?.ENABLE_API_KEYS_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2 mb-2.5">
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									...
									>
										{$i18n.t('Para saber mais sobre o Dochat, visite dochat.epilogos.eu.')}
									</a>
								</div>
							</div>
						{/if}
							...
							<div class="mt-2 text-xs">
								...
								>
									<div>
										...
										<span
											><a href={DOCHAT_SITE_URL} target="_blank" class=" underline"
